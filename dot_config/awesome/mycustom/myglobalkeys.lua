...
globalKeys = gears.table.join(
    ...
    awful.key({ "Ctrl", "Mod1" }, "Delete", function() vars.launch() end,
    ...
    awful.key({ }, "XF86MonBrightnessDown", function ()
            awful.util.spawn("sudo light -s sysfs/backlight/intel_backlight -U 5") end),
    awful.key({ }, "XF86MonBrightnessUp", function ()
            awful.util.spawn("sudo light -s sysfs/backlight/intel_backlight -A 5") end),

    -- Sound Volume
    awful.key({ }, "XF86AudioRaiseVolume", function ()
            awful.util.spawn("amixer sset Master 1%+", false) end),
